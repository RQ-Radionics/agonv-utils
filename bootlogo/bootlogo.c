...
/* ── CPU chip icon (chars 200–247 + 248, 6x8 cell grid = 48x64 px) ─────────
 *
 ...
 *
 * Design: CPU/chip icon (symmetrical)
 *   - Dark blue body (rounded corners), x=8..39 y=8..55
 *   - Gold interior square with chamfered bottom-right corner
 *   - 3 gold pins on each of the 4 sides
 *
 * Color indices:
 *   bg exterior = 0  (black)
 *   bg body     = 1  (dark blue)  — set per-cell
 *   fg gold     = 14 (bright yellow, ≥16 colours) or 6 (brown)
 *
 * cell_type per cell: 0=exterior(black bg), 1=blue body, 2=gold pin/interior
 * For type 0: bg=black,  fg=gold  (bitmap marks gold pins in outer area)
 * For type 1: bg=blue,   fg=gold  (bitmap marks gold interior pixels)
 * For type 2: bg=blue,   fg=gold  (all-gold cell inside body)
 *
 * Char 248 = solid block (used by colour_bar)
 */
static const uint8_t riscv_logo_chars[] = {
    /* Row 0 — pins top (gold on black) */
    23,200, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r0c0 exterior */
    23,201, 0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03, /* r0c1 pin top  */
    23,202, 0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3, /* r0c2 pins x2  */
    23,203, 0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3, /* r0c3 pins x2  */
    23,204, 0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0, /* r0c4 pin top  */
    23,205, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r0c5 exterior */
    /* Row 1 — top of body */
    23,206, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF, /* r1c0 pin left */
    23,207, 0x3F,0x7F,0xFF,0xFF,0xFF,0xF8,0xF8,0xF8, /* r1c1 body top */
    23,208, 0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00, /* r1c2 body top */
    23,209, 0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00, /* r1c3 body top */
    23,210, 0xFC,0xFE,0xFF,0xFF,0xFF,0x0F,0x0F,0x0F, /* r1c4 body top */
    23,211, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF, /* r1c5 pin rgt  */
    /* Row 2 — body + pins left/right */
    23,212, 0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00, /* r2c0 pin left */
    23,213, 0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8, /* r2c1 body/int */
    23,214, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r2c2 interior */
    23,215, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r2c3 interior */
    23,216, 0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0, /* r2c4 body/int */
    23,217, 0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00, /* r2c5 pin rgt  */
    /* Row 3 — body + pins left/right */
    23,218, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00, /* r3c0 pin left */
    23,219, 0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8, /* r3c1 body/int */
    23,220, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r3c2 interior */
    23,221, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r3c3 interior */
    23,222, 0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0, /* r3c4 body/int */
    23,223, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00, /* r3c5 pin rgt  */
    /* Row 4 — body + pins left/right */
    23,224, 0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, /* r4c0 pin left */
    23,225, 0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8, /* r4c1 body/int */
    23,226, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r4c2 interior */
    23,227, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r4c3 interior */
    23,228, 0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0, /* r4c4 body/int */
    23,229, 0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, /* r4c5 pin rgt  */
    /* Row 5 — body + chamfer begins */
    23,230, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r5c0 exterior */
    23,231, 0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8,0xF8, /* r5c1 body/int */
    23,232, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r5c2 interior */
    23,233, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, /* r5c3 interior */
    23,234, 0x0F,0x0F,0x0F,0x0F,0x0F,0x1F,0x3F,0x7F, /* r5c4 chamfer  */
    23,235, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r5c5 exterior */
    /* Row 6 — bottom of body */
    23,236, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r6c0 exterior */
    23,237, 0xF8,0xF8,0xF8,0xFF,0xFF,0xFF,0x7F,0x3F, /* r6c1 body bot */
    23,238, 0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF, /* r6c2 body bot */
    23,239, 0x00,0x01,0x03,0xFF,0xFF,0xFF,0xFF,0xFF, /* r6c3 body bot */
    23,240, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFE,0xFC, /* r6c4 body bot */
    23,241, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r6c5 exterior */
    /* Row 7 — pins bottom (gold on black) */
    23,242, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r7c0 exterior */
    23,243, 0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03, /* r7c1 pin bot  */
    23,244, 0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3, /* r7c2 pins x2  */
    23,245, 0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3, /* r7c3 pins x2  */
    23,246, 0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0, /* r7c4 pin bot  */
    23,247, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, /* r7c5 exterior */
    /* Solid block for colour_bar */
    23,248, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
};

/*
 * print_riscv_banner — draws the CPU chip icon (6×8 cell grid) + text.
 *
 * cell_bg[row][col]: 0=black exterior, 1=dark blue body
 * cell_type[row][col]: 0=exterior, 1=body(blue bg+gold fg), 2=gold pin(black bg)
 * Gold = index 14 (bright yellow, ≥16 colours) or 6 (brown, <16 colours).
 */

/*
 * Per-cell table:
 *   0 = black bg, no fg drawn (exterior gap)
 *   1 = blue bg,  gold fg     (body area, incl. interior gold)
 *   2 = black bg, gold fg     (pin area outside body)
 */
static const uint8_t riscv_cell_fg[8][6] = {
    {0, 2, 2, 2, 2, 0},  /* row 0: . pin pin pin pin . */
    {2, 1, 1, 1, 1, 2},  /* row 1: pin body body body body pin */
    {2, 1, 1, 1, 1, 2},  /* row 2: pin body gold gold body pin */
    {2, 1, 1, 1, 1, 2},  /* row 3: pin body gold gold body pin */
    {2, 1, 1, 1, 1, 2},  /* row 4: pin body gold gold body pin */
    {0, 1, 1, 1, 1, 0},  /* row 5: . body gold gold chamfer . */
    {0, 1, 1, 1, 1, 0},  /* row 6: . body body body body . */
    {0, 2, 2, 2, 2, 0},  /* row 7: . pin pin pin pin . */
};
...
static void print_riscv_banner(uint8_t num_colours)
{
    ...
    for (int cr = 0; cr < 8; cr++) {
        for (int cc = 0; cc < 6; cc++) {
            uint8_t ct = riscv_cell_fg[cr][cc];
            /* Set background per cell type */
            if (ct == 1) {
                vdu(17); vdu(128 + 1); /* blue bg */
            } else {
                vdu(17); vdu(128 + 0); /* black bg */
            }
            /* Set foreground */
            if (ct == 0) {
                vdu(17); vdu(0);    /* black fg — invisible on black bg */
            } else {
                vdu(17); vdu(gold); /* gold fg */
            }
        ...
        if (cr == 1) {
            ...
            vdu(17); vdu(7);   /* fg light gray */
            vdu(' '); vdu(' ');
            vdu('E'); vdu('S'); vdu('P'); vdu('3'); vdu('2');
            vdu('-'); vdu('P'); vdu('4');
        }
        vdu(13); vdu(10); /* CR LF */
    }
